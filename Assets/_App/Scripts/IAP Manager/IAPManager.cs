...
public class IAPKey
{
    public const string PACK1 = "lattice_mania_pack_1";
    public const string PACK2 = "lattice_mania_pack_2";
    public const string PACK3 = "lattice_mania_pack_3";
    public const string PACK4 = "lattice_mania_pack_4";
    public const string PACK5 = "lattice_mania_pack_5";
    public const string PACK6 = "lattice_mania_pack_6";
    public const string PACK7 = "lattice_mania_pack_7";
    public const string PACK8 = "lattice_mania_pack_8";
    public const string PACK9 = "lattice_mania_pack_9";
}
