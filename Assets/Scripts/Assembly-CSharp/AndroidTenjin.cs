...
public class AndroidTenjin : BaseTenjin
{
	private class DeferredDeeplinkListener : AndroidJavaProxy
	{
		...
		public void onSuccess(bool clickedTenjinLink, bool isFirstSession, AndroidJavaObject data)
		{
			...
			string value = data.Call<string>("get", new object[1] { "ad_network" });
			string value2 = data.Call<string>("get", new object[1] { "campaign_id" });
			string value3 = data.Call<string>("get", new object[1] { "advertising_id" });
			string value4 = data.Call<string>("get", new object[1] { "deferred_deeplink_url" });
	...
	{
		Debug.Log("Android Initializing " + apiKey);
		base.ApiKey = apiKey;
		initActivity();
		...
		tenjinJava = androidJavaClass.CallStatic<AndroidJavaObject>("getInstance", new object[2] { activity, apiKey });
	}

	public override void Init(string apiKey, string sharedSecret)
	{
		Debug.Log("Android Initializing with Shared Secret" + apiKey);
		base.ApiKey = apiKey;
		...
		tenjinJava = androidJavaClass.CallStatic<AndroidJavaObject>("getInstance", new object[3] { activity, apiKey, sharedSecret });
	}
	...
	public override void Connect()
	{
		...
		object[] args = new object[2] { null, text };
	...
	public override void Connect(string deferredDeeplink)
	{
		...
		object[] args = new object[2] { deferredDeeplink, text };
		tenjinJava.Call("connect", args);
	}

	public override void SendEvent(string eventName)
	{
		object[] args = new object[1] { eventName };
		tenjinJava.Call("eventWithName", args);
	}

	public override void SendEvent(string eventName, string eventValue)
	{
		object[] args = new object[2] { eventName, eventValue };
	...
	public override void Transaction(string productId, string currencyCode, int quantity, double unitPrice, string transactionId, string receipt, string signature)
	{
		...
		{
			object[] args = new object[6] { productId, currencyCode, quantity, unitPrice, receipt, signature };
		...
		{
			object[] args2 = new object[4] { productId, currencyCode, quantity, unitPrice };
	...
	{
		tenjinJava.Call("optInParams", new object[1] { parameters.ToArray() });
	}

	public override void OptOutParams(List<string> parameters)
	{
		tenjinJava.Call("optOutParams", new object[1] { parameters.ToArray() });
	}
}
