...
public class OneSignal : MonoBehaviour
{
	...
	internal static OnSetEmailSuccess setEmailSuccessDelegate;

	internal static OnSetEmailFailure setEmailFailureDelegate;

	internal static OnLogoutEmailSuccess logoutEmailSuccessDelegate;

	internal static OnLogoutEmailFailure logoutEmailFailureDelegate;
	...
	private void onSetEmailSuccess()
	{
		...
		{
			OnSetEmailSuccess onSetEmailSuccess = setEmailSuccessDelegate;
	...
	private void onSetEmailFailure(string error)
	{
		...
		{
			OnSetEmailFailure onSetEmailFailure = setEmailFailureDelegate;
			setEmailFailureDelegate = null;
			setEmailSuccessDelegate = null;
	...
	private void onLogoutEmailSuccess()
	{
		...
		{
			OnLogoutEmailSuccess onLogoutEmailSuccess = logoutEmailSuccessDelegate;
	...
	private void onLogoutEmailFailure(string error)
	{
		...
		{
			OnLogoutEmailFailure onLogoutEmailFailure = logoutEmailFailureDelegate;
			logoutEmailFailureDelegate = null;
			logoutEmailSuccessDelegate = null;
